...
const GOOGLE_API_KEY = "AIzaSyDYZX48qHyGHcSx8LPe9cufxZfAByyE1Bo";
    ...
    savedConversations.forEach(conversation => {
        ...
        const userMessageHtml = `
            ...
            <div class="message__content">
                <img class="message__avatar" src="assets/av.png" alt="User avatar">
        ...
        const responseHtml = `
           ...
           <div class="message__content">
                <img class="message__avatar" src="assets/d.gif" alt="Gemini avatar">
...
const requestApiResponse = async (incomingMessageElement) => {
    ...
    try {
        ...
        if (!responseText) throw new Error("Wff Sorry .");
...
const displayLoadingAnimation = () => {
    const loadingHtml = `
        ...
        <div class="message__content">
            <img class="message__avatar" src="assets/b.gif" alt="Gemini avatar">
            <p class="message__text"></p>
